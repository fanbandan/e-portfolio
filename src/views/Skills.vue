      ...
      <v-row>
        <v-col cols="12" md="6">
          <v-card>
            ...
            <v-divider></v-divider>
            <v-card-text>
              <div class="font-weight-bold">Communication</div>
              <div>
        ...
        <v-col cols="12" md="6">
          <v-card>
            <v-card-title> Technical Skills & Qualifications </v-card-title>
            <v-card-text>
            ...
            <v-divider></v-divider>
            <v-card-text>
              <div class="font-weight-bold">White Card</div>
            </v-card-text>
            <v-divider></v-divider>
            <v-card-text>
              <div class="font-weight-bold">Drivers License</div>
            </v-card-text>
          </v-card>
        </v-col>
      </v-row>
